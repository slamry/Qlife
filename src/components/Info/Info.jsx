      ...
      <Box className={styles.results_wrapp}>
        <Typography className={styles.results_text}>
          <img
            ...
            alt=""
          />
          После игры 95% участников чувствуют ясность сознания и откидывают все
          ненужное. Quality life помогает понять важность баланса в вашей жизни.
          В процессе игры вы наладите контакт с людьми, которые уже достигли
          успеха в разных сферах и готовы поделиться опытом.
        </Typography>
        <Typography className={styles.results_text}>
          <img
            className={styles.marker}
            ...
            alt=""
          />
          Другими словами, всего за час вы проживаете альтернативную жизнь “от”
          и “до”: взаимодействуете с другими игроками и принимаете решения о
          карьере, семье, здоровье, финан сах и благополучии. Также, в игре
          происходят поворотные события, круто влияющие на вашу жизнь. Все как в
          реальности, только на игровом поле.
        </Typography>
      </Box>
    </Box>
  );
